...
• Payment processors (Paystack, Flutterwave) to complete transactions.
• Delivery and logistics partners to fulfil orders.
• Cloud hosting and storage providers that support our platform.
...
No refund shall be processed unless the original transaction has been positively identified and confirmed through our payment gateway records. Refunds will only be issued to the same payment method or account used for the original transaction, following verification that the payment was received and the order was not properly fulfilled or was materially defective as described in this policy.
...
export const POLICY_META: Record<
  PolicyType,
  { title: string; subtitle: string; field: 'privacy_policy' | 'terms_of_service' | 'refund_policy'; defaultContent: string }
> = {
  privacy: {
  ...
  refund: {
    title: 'Refund Policy',
    subtitle: 'Our commitment to fair refunds and customer satisfaction.',
    field: 'refund_policy',
